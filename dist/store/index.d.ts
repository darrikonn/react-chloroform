...
export declare const withNewLocalStore: (reducers: Function) => <P extends object>(WrappedComponent: any) => {
    new (props: P): {
        store: ContextStore;
        getChildContext(): {
            store: ContextStore;
...
export declare const connect: (stateToProps?: Function | undefined, dispatchToProps?: {
    [key: string]: Function;
} | undefined) => <P extends object>(WrappedComponent: React.ComponentType<P>) => {
    new (props: P, { store }: Context): {
